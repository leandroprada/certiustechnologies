...
return array(
    ...
    it_counter,it_testimonials,it_member,it_gmap,it_steps,vc_single_image,vc_column_text,vc_message,vc_tta_tabs,vc_tta_tour,
    ...
    "params" => array(
        array(
            ...
            "param_name" => "sw_height2",
            'value' => '400',
            "description" => esc_html__("Type the slider height in px(Ex: 250).", "js_composer"),
        ),array(
            "type" => "numberfield",
