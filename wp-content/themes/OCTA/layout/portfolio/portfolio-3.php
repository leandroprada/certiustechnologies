...
<div class="md-padding">
    <div class="container">
        <div class="row row-eq-height">
            ...
            <div class="col-md-8">
                <div class="heading style2 left with-icon">
                    <h4 class="uppercase head_tag main-color"> <?php echo esc_html__('Case', 'octa') ?> <span class="black"><?php echo esc_html__('Study', 'octa') ?></span></h4>
                    <span class="head-ico"><i class="fa fa-desktop main-color"></i></span>
                </div>
                <?php gr_content(); ?>
                <?php if ( has_post_thumbnail() ){ ?>
                <?php if ( theme_option('singleprojectimg_on') == "1" ) { ?>
                    <div class="divider trimg"></div>
                    <div class="heading style2 left with-icon">
                        <h4 class="uppercase head_tag main-color"> <?php echo esc_html__('Project', 'octa') ?> <span class="black"><?php echo esc_html__('Photo', 'octa') ?></span></h4>
                        <span class="head-ico"><i class="fa fa-image main-color"></i></span>
                    </div>
                    <div class="full-img">
            ...
            <?php } ?>
            <div class="col-md-4">
                <div class="p-a-3 gry-border bordered">
                    <div class="heading style4 left">
                        <h4 class="uppercase head_tag main-color"><?php echo esc_html__('Project', 'octa') ?> <span class="black"><?php echo esc_html__('Info', 'octa') ?></span></h4>
                    </div>
    ...
    <div class="row m-r-0 m-l-0 ics-row">
        ...
        <div class="sm-padding ic-cell">
            <div class="text-center font-40">
                ...
                <span class="m-b-2 odometer" data-value="<?php echo esc_attr($options['icons_value'.$i][0]) ?>" data-timer="500"></span>
                <?php } ?>
                <?php if(isset($options['icons_title'.$i][0])){ ?>
                <h4 class="white"><?php echo esc_html($options['icons_title'.$i][0]) ?></h4>
                <?php } ?>
            </div>
        </div>
