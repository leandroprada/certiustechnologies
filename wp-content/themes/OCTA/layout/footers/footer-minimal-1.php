...
?>
<footer id="footWrapper" class="footer-minimal<?php echo esc_attr($light).esc_attr($fixed); ?>">
    ...
    <div class="footer-middle">
        <div class="container">
            ...
            <div class="pull-left footer-logo-txt">
            ...
            <ul class="minimal-info pull-right">
                <?php if ( theme_option('address_minimal_footer') == "1" ) { ?>
                <li><span><i class="fa fa-map-marker"></i><?php echo esc_html(theme_option("contact_address".$langcode)); ?></span></li>
                <?php } ?>
                ...
                <li><span><i class="fa fa-phone"></i> <?php echo esc_html(theme_option('contact_phone_title'.$langcode)); ?> <?php echo esc_html(theme_option("contact_phone")); ?></span></li>
                <?php } ?>
            </ul>
            <?php } ?>
        </div>    
