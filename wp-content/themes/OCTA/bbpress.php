...
$sbar = theme_option('show_sidebar_bb');
$lay = theme_option('sidebar_position_bb');
...
$m_bar = get_post_meta(c_page_ID(),'bb_sidebar_style',true);
$t_bar = theme_option('bb_sidebar_style');
